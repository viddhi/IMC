...
public class ConstUtilities {
	...
	public static  ArrayList<HashMap<String,Object>> catPostLists = null;
	public static  ArrayList<HashMap<String,Object>> categoriesLists = null;
	public static ArrayList<HashMap<String,Object>> commentLists = null;
	public static boolean FromNotification = false;
	public static boolean FromExplore = false;
